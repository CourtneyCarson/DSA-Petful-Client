    ...
    return (
      <main className='landing-fullpage'>
        <div className='landing-page'>
          ...
          <Link to='/adopt'><button>Preview Adoptable Pets</button> </Link>

          <h4> We match the first person in the queue to the first pet that arrived at the shelter so no pets are left behind.</h4>
          ...
          <form className='get-started' onSubmit={this.handleSubmit}>
            <h4> Add your name to the queue to be matched with your new furry friend.</h4>
            <h3> Adopt Today </h3>
